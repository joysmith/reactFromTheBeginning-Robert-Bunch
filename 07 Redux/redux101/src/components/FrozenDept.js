...
class FrozenDept extends Component {
  increment = (operation, index) => {
    ...
    // now the code will run and goes to the dispatch, after to each reducer
    this.props.updateFrozen(operation, index);
  };

  render() {
    // accessing state by local key
...
function mapDispatchToProps(dispatch) {
  ...
  return bindActionCreators(
    {
      // key is used as local props in this component
      // value is assigned to action creator function
